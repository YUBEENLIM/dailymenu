...
import com.example.dailymenu.adapter.out.persistence.entity.UserJpaEntity;
import com.example.dailymenu.adapter.out.persistence.entity.UserPreferencesJpaEntity;
import com.example.dailymenu.adapter.out.persistence.entity.UserRestrictionJpaEntity;
import com.example.dailymenu.adapter.out.persistence.repository.UserJpaRepository;
import com.example.dailymenu.domain.menu.MenuCategory;
import com.example.dailymenu.domain.user.UserPreferences;
import com.example.dailymenu.domain.user.UserProfile;
import com.example.dailymenu.domain.user.UserRestriction;
import com.example.dailymenu.domain.user.port.UserProfileRepositoryPort;
import com.example.dailymenu.domain.user.vo.HealthFilter;
import com.example.dailymenu.domain.user.vo.RestrictionType;
